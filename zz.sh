...
src_file="./data/processed/en-kn-te/10k_pmindia/test".kn-te.$src_lang
model_dir=$ROOT/dumped/multi/en-kn-te/unsupervised/kn-te_pmindia/
model_path="$model_dir/best-valid_kn-te_mt_bleu.pth"
...
ref_file_orig="./data/data_final/test."kn-te.$tgt_lang
