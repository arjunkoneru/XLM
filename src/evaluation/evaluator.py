    ...
    def run_all_evals(self, trainer):
        ...
        with torch.no_grad():
            ...
            for data_set in ['valid', 'test']:
                ...
                for lang1, lang2 in set(params.mt_steps +  [(l2, l3) for _, l2, l3 in params.bt_steps] + [(l2, l3) for _, l2, l3 in params.pt_steps] ):
...
def eval_moses_bleu(ref, hyp):
    ...
    assert os.path.isfile(BLEU_SCRIPT_PATH)
    #command = 'cat %s | sacrebleu %s'
    #p = subprocess.Popen(command % (str(hyp),str(ref)), stdout=subprocess.PIPE, shell = True)
