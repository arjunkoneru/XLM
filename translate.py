...
def main(params):
    ...
    setattr(model_params,'activation_dropout',0)
    ...
    for i in range(0, len(src_sent), params.batch_size):
        ...
        #decoded, dec_lengths = decoder.generate_beam(encoded, lengths.cuda(), params.tgt_id,5,1.2,False, max_len=int(1.5 * lengths.max().item() + 10))
